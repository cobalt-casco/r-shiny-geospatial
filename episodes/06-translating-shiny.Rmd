...
trans_shiny <- shinyApp(ui, server)

appshot(trans_shiny, "shiny_figs/tans_shiny.jpeg",
        vwidth = 800, vheight = 600)
```

![an app with translation](shiny_figs/tans_shiny.jpeg)
...
i18n_app <- shinyApp(ui, server)
appshot(i18n_app, "shiny_figs/i18n_app.jpeg",
        vwidth = 800, vheight = 600)
```
